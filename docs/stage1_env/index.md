...
## 🛠️ 【分類二】 開發工具整合 (VS Code & AI 助手)

### 2. IDE 安裝：VS Code 及必裝擴充套件
...
### 7. GPU 支援：NVIDIA Driver & NVIDIA Container Toolkit (重要 ⚠️)
